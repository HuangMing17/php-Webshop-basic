...
// Định nghĩa base URL để sử dụng trong toàn bộ ứng dụng
define('BASE_URL', '/hoangduyminh/');

// Định nghĩa đường dẫn uploads
...
if ($controllerName === 'ApiController' && isset($url[1])) {
    ...
    if (file_exists('app/controllers/' . $apiControllerName . '.php')) {
        ...
        if ($url[1] === 'product' && isset($url[2]) && $url[2] === 'upload-image' && $method === 'POST') {
